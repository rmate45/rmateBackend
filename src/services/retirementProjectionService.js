...
const calculateStrengtheningVariables = async (
  ...
  try {
    ...
    return [
      ...
      `1. Increase your monthly contribution to 15%-20% ($${(CONTRIB_15_DOLLARS / 1000).toFixed(1)}K–$${(CONTRIB_20_DOLLARS / 1000).toFixed(1)}K/mo): <strong>+${YEARS_15}-${YEARS_20} years</strong>.\n\n`,
      `A higher contribution rate compounds over time and meaningfully extends how long your balance lasts.<br><br>`,
      `2. Delay collecting Social Security 1–3 years (start at age 68-70): <strong>+${YEARS_SS_DELAY_LOW}-${YEARS_SS_DELAY_HIGH} years</strong>.\n\n`,
      `Delaying increases your monthly benefit by up to 24%, reducing the amount you need to withdraw each year.<br><br>`,
      `3. Shift your transition away from full-time work by ${WORK_SHIFT_RANGE} years: <strong>+${YEARS_WORK_SHIFT_LOW}-${YEARS_WORK_SHIFT_HIGH} years</strong>.\n\n`,
      `Each additional working year adds income and shortens the withdrawal period, buying you more retirement time.<br><br>`,
      `4. Improve your long-term growth rate to 7.5%–9%: <strong>+${YEARS_GROWTH_LOW}-${YEARS_GROWTH_HIGH} years</strong>.\n\n`,
      `Higher long-term returns can significantly increase your peak savings and slow down future drawdowns.<br><br>`,
      `5. Reduce long-term costs by ${COST_REDUCTION_TARGET}: <strong>+${YEARS_COST_REDUCTION_LOW}-${YEARS_COST_REDUCTION_HIGH} years</strong>.\n\n`,
